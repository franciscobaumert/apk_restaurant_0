...
<div class="row">
      <div class="col-xs-12">
        <div class="box box-success">
          ...
          <div class="box-body">
            <form  name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="ventasproveedor1.php">
                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label>Nombre del Proveedor:</label>
                    <input placeholder="Nombre del proveedor" type="text" value="<?php echo $proveedor;?>" name="proveedor" id="autocomplete-custom-append" data-validate-length-range="4" class="form-control col-md-10" style="float: left;" onKeyUp="this.value=this.value.toUpperCase();"/>
...
?>
    ...
    <tbody>  
<?php   
$sql="select * from facturas,clientes,users where facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.ven_com=2 and facturas.activo=1"; 
$s=1;
...
if($proveedor1==$proveedor  && $fecha>=$fech1 && $fecha<=$fech2 && $tienda>=$tienda1 && $tienda<=$tienda2){
    if($moneda==1){
...
<?php 
        if($_SESSION['tabla']>0)        {
        ?>
            <!--<tr><td colspan="5"></td><td><h2 style="color:blue;">Total Compras :</h2></td><td><h2 style="color:red;">S/.<?php echo number_format ($total1,2);?></h2></td></tr>-->
                <?php
                }
                ?>
        </table>
...
<script type="text/javascript">
    ...
    $('#ventasproveedor').addClass("active");
