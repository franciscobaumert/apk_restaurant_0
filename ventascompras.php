...
<div class="row">
      <div class="col-xs-12">
        <div class="box box-success">
          ...
          <div class="box-body">
            <form  name="myForm"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="ventascompras1.php">
                     <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                          <label>Nombre del usuario:</label>
                        <input placeholder="Nombre del usuario" type="text" value="<?php echo $vendedor;?>" name="vendedor" id="autocomplete-custom-append" data-validate-length-range="4" class="form-control col-md-10" style="float: left;" onKeyUp="this.value=this.value.toUpperCase();"/>
