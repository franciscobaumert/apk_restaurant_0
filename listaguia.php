        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-2">
                                                                Buscar Doc
                <input type="text" autocomplete="off" class="form-control" id="q1" placeholder="Nro guia " onkeyup='load(1);this.value=this.value.toUpperCase();'>
              </div>
              <div class="col-md-3">
                                                                Buscar Fecha
                <input type="date"  class="form-control" id="q2"  onkeyup='load(1);this.value=this.value.toUpperCase();'>
              </div>
