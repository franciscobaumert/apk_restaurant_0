          ...
          <div class="box-header">
            <div class="btn-group pull-right">
              <div class="dropdown btn btn-info">
                        <div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="glyphicon glyphicon-plus" ></span> Nuevo Proveedor</div>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                <li><a href="#" data-toggle="modal" data-target="#nuevoProveedoresruc"><i class="fa fa-plus"></i> Buscar RUC</a></li>
                <li><a href="#" data-toggle="modal" data-target="#nuevoProveedores"><i class="fa fa-plus"></i> Buscar DNI</a></li>
