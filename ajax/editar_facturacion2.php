...
<?php
    ...
    $sumador_total+=$precio_total_r;//Sumador
        ...
        <tr class="invoice-item">
            ...
            <td class='product-price'><input readonly id="precio-<?php echo $id_detalle;?>" name="precio-<?php echo $id_detalle;?>" class="monto input text-center item_price" type="text" value="<?php echo $precio_venta_f;?>" style="max-width:80px;border-radius: 20px;border:2px solid #ddd;"></td>
            ...
            <td class='product-delete text-red'>
                ...
                ?>
                <?php if($a[27]==1){ ?>
                <a href="#" class='btn btn-xs' onclick="eliminar('<?php echo $id_detalle; ?>')"><span class="fa fa-close"></span></a>
                <?php } ?>
            </td>
        </tr>     
        <?php }
