...
<?php
    ...
    if (isset($_GET['id'])){
        ...
        if ($count==0){
            ...
            toastr.success("Proveedor eliminado","Exito");
                </script>
            <?php 
        }else {
            ?>
            ...
            toastr.warning("Proveedor asociado con documentos","Precaucion");
                </script>
            <?php
        }
    }
    if($action == 'ajax'){
        ...
        if ($numrows>0){    
          ...
          <div class="alert alert-danger alert-custom alert-dismissible">
            <br><br>
            <h4 class="alert-title">No hay Proveedores</h4>
            <p>No se han agregado Proveedores a la base de datos, puedes agregar uno dando click en el boton <b>"Agregar Proveedores"</b>.</p>
            <br><br>
          </div>
          <br><br><br>
          <?php
