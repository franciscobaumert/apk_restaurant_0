<?php
	...
	if (empty($_POST['mod_pago'])) {
		...
		$sql="INSERT INTO facturas (numero_factura,fecha_factura,fecha_entrega,ot,id_cliente,baja,id_vendedor,condiciones,total_venta,deuda_total,estado_factura,tienda,ven_com,activo,servicio,moneda,nombre,obs,cuenta1,cuenta2,dias,folio) VALUES ('$numero_factura','$date_added','0','0','$cliente','0','$vendedor','$condiciones','$pago','0','$estado_factura','$tienda','4','1','$id','$mon1','$cuenta','$obs','0','0','0','0')";
