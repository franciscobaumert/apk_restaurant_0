...
if ($con)
{
    $fetch = mysqli_query($con,"SELECT * FROM clientes where dni like '%" . mysqli_real_escape_string($con,($_GET['term'])) . "%' or ce like '%" . mysqli_real_escape_string($con,($_GET['term'])) . "%'  LIMIT 0 ,50"); 
