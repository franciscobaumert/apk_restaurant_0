<?php
	...
	if (isset($_GET['id'])){
		...
		$numrows = $row2['numrows'];
            ...
            toastr.success("Cotizacion eliminada","Exito");
            </script>
			<?php 
		}else{
			?>
            ...
            toastr.error("No se puede eliminar la cotizacion","Error");
            </script>
			<?php
	...
	if($action == 'ajax'){
		...
		if ($numrows>0){
					...
					<tr id="valor1">
						...
						<?php  
                                                if ($estado_factura1==1){
                                                    ?>
                                                <a href="guia.php?accion=<?php echo $id_factura;?>" class='fa fal-file-word' title='Guia de remision' ><i class="glyphicon glyphicon-download"></i></a> 
                                                 <?php
                                                }   
                                                ?>
                                                
                                                <a  style="cursor: pointer;" class='btn btn-warning btn-xs' title='Enviar correo' onclick="imprimir_factura1('<?php echo $id_factura;?>');"><i class="fa fa-envelope-o"></i></a> 
          ...
          <div class="alert alert-danger alert-custom alert-dismissible">
            <br><br>
            <h4 class="alert-title">No hay Cotizaciones</h4>
            <p>No se han agregado Cotizaciones a la base de datos.</p>
            <br><br>
          </div>
          <br><br><br>
          <?php
