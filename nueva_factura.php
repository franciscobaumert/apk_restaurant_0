...
<head>
  ...
  <title>.:: Nuevo Pedido | Casa Royales ::. </title>
        ...
        if($_SESSION['tienda']==6){
            ...
            $doc11=$valor3['folio6'];
                  ...
                  <input type="text" autocomplete="off" class="form-control " id="direccion_cliente" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Dirección del cliente" <?php echo $required;?> style="height: 30px;">
                   ...
                   <option value=0>NO MOVER STOCK</option>   
                     ...
                     <?php date_default_timezone_set('America/Santiago');?>
                      ...
                      Número de Documento<input type="text" value="<?php echo $doc;?>" class="form-control " id="factura" placeholder="Número de doc" readonly required>
                      </div>
                ...
                <div id="invoice-item">
                  ...
                  <div class="col-md-12">
                    <textarea class="form-control" name="observaciones" id="observaciones" cols="30" rows="2" style="resize: none;" placeholder="Observaciones..." onKeyUp="this.value=this.value.toUpperCase();"></textarea>
                  </div>

                  <div class="col-md-6 hidden" style="padding-top: 5px; padding-bottom: 5px;"> 
...
<input autocomplete="off" type="hidden" value="0" class="form-control " id="dias" name="dias" placeholder="Número de días de crédito">
                ...
                <div id="pay-button" class="text-center">
                  <button type="submit" class="btn btn-block btn-lg" title="Procesar Pedido">
                    ...
                    <span class="hidden-xs">Pedido</span>
                  </button>
                </div>
       ...
       var fecha = $("#fecha").val();
                    ...
                    var observaciones = $("#observaciones").val();
                        ...
                        if ((n == 11 && tip_doc==2) |  (n == 8 && tip_doc==1) ) {
                            VentanaCentrada('./pdf/documentos/pedido.php?id_cliente='+id_cliente+'&id_vendedor='+id_vendedor+'&factura='+factura+'&dias='+dias+'&condiciones='+condiciones+'&fecha='+fecha+'&hora='+hora+'&moneda='+moneda+'&tcp='+tcp+'&folio='+folio+'&nro_doc='+nro_doc+'&motivo='+motivo+'&nombre_cliente='+nombre_cliente+'&doc1='+doc1+'&tip_doc='+tip_doc+'&tel1='+tel1+'&mail='+mail+'&direccion='+direccion+'&des='+des+'&tip='+tip+'&id_mesa='+id_mesa+'&observaciones='+observaciones,'Factura','','1024','768','true');
