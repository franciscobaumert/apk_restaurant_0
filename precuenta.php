...
<!-- Aqu¨ª todo el c¨®digo para mesas y sillas -->                                         
...
<?php 
    ...
    imprimir_precuenta.php?id_factura=<?php echo $id_factura; ?>&id_mesa=<?php echo $id_mesa; ?> 
    ...
    <?php } ?>">
                    <div id="<?php
                        ...
                        ?>yellow;" class="miMesa"><?php if ($status_mesa == '0'){ ?><img src="assets/img/table.svg" style="padding:12px;margin:11px;float:left;width:90px;border-radius: 0px;"><?php } else { ?><img src="assets/img/tableB1.svg" style="padding:12px;margin:11px;float:left;width:90px;border-radius: 0px;"><?php } ?></div>
                    <center><strong><?php
                        echo $nombre_mesa;
                        ?></strong></center>
                </a>
