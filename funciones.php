...
?>
<script type="text/javascript" src="asset/script/script2.js"></script>
<script type="text/javascript" src="asset/script/jscompras.js"></script>
<script type="text/javascript" src="asset/script/jsventas.js"></script>
<script src="asset/script/jscalendario.js"></script>
<script src="asset/script/autocompleto.js"></script> 
<!-- Calendario -->
...
$reg = $tra->UsuariosPorId();
  ...
  <tr>
    <td><strong>DNI:</strong> <?php echo $reg[0]['cedula']; ?></td>
  </tr>
  <tr>
  ...
  <tr><?php $codigousuario = $reg[0]['codigo']; ?>
    <td><strong>Correo Electr&oacute;nico: </strong> <?php if($codigousuario==1) { echo "--- CORREO SIN ASIGNAR ---"; }else { echo $reg[0]['email']; } ?></td>
  </tr>
  <tr>
...
$reg = $tra->SalasPorId();
 ...
 <div id="div1" class="responsive-table"> <table id="datatable-responsive" class="table table-striped table-bordered nowrap dataTable no-footer collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>N&deg;</th>
...
$reg = $tra->ClientesPorId();
  ...
  <table border="0" align="center" >
  <tr>
    <td><strong>Documento de Cliente:</strong> <?php echo $reg[0]['cedcliente']; ?></td>
  </tr>
  <tr>
...
$reg = $tra->ProveedoresPorId();
  ...
  <table border="0" align="center" >
  <tr>
    <td><strong>N&deg; Tributario:</strong> <?php echo $reg[0]['ritproveedor']; ?></td>
  </tr>
  <tr>
...
<?php 
############################# MOSTRAR NUMERO DE INGREDIENTE##########################
if (isset($_GET['muestranroingrediente'])) {
  
$tra = new Login();
  ?>
<input type="hidden" name="codprocesoing" id="codprocesoing" value="<?php echo GenerateRandomString(); ?>">
<?php 
  }
############################# MOSTRAR NUMERO DE INGREDIENTE##########################
?>
...
<?php 
############################# MUESTRA CODIGO DE INGREDIENTE #############################
if (isset($_GET['muestracodigoingrediente'])) {
  
$tra = new Login();
  ?>
<input type="text" class="form-control" name="codingrediente" id="codingrediente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Código de Ingrediente" <?php if (isset($reg[0]['codingrediente'])) { ?> value="<?php echo $reg[0]['codingrediente']; ?>" readonly="readonly" <?php } ?>  value="<?php echo $reg = $tra->CodigoIngrediente(); ?>" required="" aria-required="true">
...
<hr />
<div id="div1">
    <div class="responsive-table" data-pattern="priority-columns">
              <table id="tech-companies-1" class="table table-striped table-bordered nowrap dataTable no-footer collapsed">
                                                <thead>
                                                    <tr>
...
?>
                             <tr>
<td><abbr title="<?php echo $busq[$i]["documentoing"]; ?>"><?php if($busq[$i]["codresponsableing"]=="0") { echo "INVENTARIO INICIAL"; } elseif($busq[$i]["movimientoing"]=="ENTRADAS"){ echo $busq[$i]["proveedor"]; } elseif($busq[$i]["movimientoing"]=="SALIDAS"){ echo $busq[$i]["clientes"]; } ?></abbr></td>
...
if (isset($_GET['BuscaKardexIngrediente']) && isset($_GET['codingrediente'])) { 
  ...
  ?>
  <h3 class="panel-title"> Movimientos del Ingrediente <?php echo $reg[0]['nomingrediente']; ?></h3>
  <br>
      
                                <div class="row"> 
                                <div class="col-md-12"> 
                               
<div id="div1"><div class="responsive-table" data-pattern="priority-columns">
                  <table id="tech-companies-1" class="table table-striped table-bordered nowrap dataTable no-footer collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
                                            <thead>
                              <tr role="row">
                                  <th>#</th>
                                  <th>Movimiento</th>
...
?>
                             <tr>
<td><abbr title="<?php echo $busq[$i]["documento"]; ?>"><?php if($busq[$i]["codresponsable"]=="0") { echo "INVENTARIO INICIAL"; } elseif($busq[$i]["movimiento"]=="ENTRADAS"){ echo $busq[$i]["proveedor"]; } elseif($busq[$i]["movimiento"]=="SALIDAS"){ echo $busq[$i]["clientes"]; } ?></abbr></td>
...
<h3 class="panel-title">Movimientos del Producto <?php echo $reg[0]['producto']; ?></h3>
<br>
...
$reg = $tra->MovimientoCajasPorId();
  ...
  <tr>
    <td><strong>Fecha de Registro:</strong> <?php echo date("d-m-Y h:i:s",strtotime($reg[0]['fechamovimientocaja'])); ?></td>
  </tr>
  <tr>
...
<abbr title="Forma de Compra"><strong>MEDIO DE PAGO:</strong></abbr> <?php echo $co[0]["mediopago"]; ?><br />
...
<h3 class="panel-title">Compras de Productos del Proveedor <?php echo $pro[0]['nomproveedor']; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
if($desde=="") {
     ...
     echo "<br><center><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR INGRESE FECHA DE INICIO PARA TU B&Uacute;SQUEDA</center>";  
     echo "</div>";
   exit;
     ...
     echo "<br><center><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR INGRESE FECHA FINAL PARA TU B&Uacute;SQUEDA</center>";  
     echo "</div>";
   exit;
...
<h3 class="panel-title">Compras por Fechas Desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
<?php 
############################# MUESTRA FORM PARA VENTAS ##############################
if (isset($_GET['ProcesaForm']) && isset($_GET['verifica'])) { 

$verifica = $_GET['verifica'];

if($_GET['verifica']=="1"){ ?>

<form class="form" method="post"  action="#" name="cierra-ventas" id="cierra-ventas">
...
echo $status = ( $favoritos[0]["codproducto"] == '' ? '' : '<hr><label class="control-label">Productos Favoritos: </label><br>');
...
<button type="button" class="button ng-scope" style="font-size:10px;border-radius:5px;width:150px; height:35px;cursor:pointer;" ert-add-pending-addition="" ng-click="afterClick()" ng-repeat="product in ::getFavouriteProducts()" OnClick="DoAction('<?php echo $favoritos[$i]['codproducto']; ?>','<?php echo $favoritos[$i]['producto']; ?>','<?php echo $favoritos[$i]['codcategoria']; ?>','<?php echo $precioconiva = ( $favoritos[$i]['ivaproducto'] == 'SI' ? $favoritos[$i]['preciocompra'] : "0.00"); ?>','<?php echo $favoritos[$i]['preciocompra']; ?>','<?php echo $favoritos[$i]['precioventa']; ?>','<?php echo $favoritos[$i]['ivaproducto']; ?>','<?php echo $favoritos[$i]['existencia']; ?>');" title="<?php echo $favoritos[$i]['producto'];?>">

<?php if (file_exists("./fotos/".$favoritos[$i]["codproducto"].".jpg")){

echo "<img src='./fotos/".$favoritos[$i]['codproducto'].".jpg?' alt='x' style='border-radius:4px;width:30px;height:25px;'>"; 
}else{
echo "<img src='./fotos/producto.png' alt='x' style='border-radius:4px;width:30px;height:25px;'>";  
} ?>

<span class="product-label ng-binding "><?php echo getSubString($favoritos[$i]['producto'], 16);?></span>
</button>
...
<button type="button" id="vaciarv" class="btn btn-danger" title="Vaciar Carrito"><span class="fa fa-trash-o"></span> Cancelar</button>    
          </div>
...
<div id="delete-detalle"></div>
    ...
    <div id="cargadetallesproductos"><table class="table table-small-font table-striped">
        <thead>
    <tr>
<th style="background:#232323;color:#FFFFFF;font-size:14px;" colspan=4><center><label>PRODUCTOS AGREGADOS</label></center>
            </th>
          </tr>
        </thead>
        <tbody>
...
<input type="hidden" name="codcaja" id="codcaja" value="<?php echo $_SESSION['codcaja'] ?>">
...
<input type="hidden" name="codcliente" id="codcliente" value="<?php echo $arqueo[0]['cliente'] ?>">
<input class="form-control" type="text" name="busquedacliente" id="busquedacliente" value="<?php echo $cliente = ( $arqueo[0]['cliente'] == '0' ? "SIN ASIGNACION" : $arqueo[0]['cedcliente'].": ".$arqueo[0]['nomcliente']); ?>" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="B&uacute;squeda de Cliente">
  </div>
</div>
...
<input class="form-control" type="text" name="mesero" id="mesero" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $arqueo[0]['nombres'] ?>" readonly="readonly">
  </div>
</div>
...
<input class="form-control number" type="text" name="montodevuelto" id="montodevuelto" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" value="0.00" autocomplete="off" placeholder="Ingrese Cambio Devuelto a Cliente" readonly="readonly" aria-required="true"> 
  </div>
</div>
...
<table class="table table-small-font table-striped">
        <thead>
    <tr>
<th style="background:#232323;color:#FFFFFF;font-size:12px;" colspan=4><label><center>PRODUCTOS AGREGADOS</center></label>
            </th>
          </tr>
        </thead>
        <tbody>
...
<h3 class="panel-title">Ventas <?php if($tipobusqueda=="1") { echo "del Cliente ".$reg[0]['nomcliente']; } 
  else if($tipobusqueda=="2") { echo "de Caja N&deg; ".$reg[0]['nrocaja']." : ".$reg[0]['nombrecaja']; } 
  else { echo "de Fecha ".$fecha; } ?> </h3>
  <br>
...
?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="pull-right">
                         <address>
<abbr title="N° de Venta"><strong>N&deg; DE VENTA: </strong> <?php echo $ve[0]["idventa"]; ?></abbr><br>
...
<h3 class="panel-title">Detalles de Ventas <?php if($tipobusquedad=="1") { echo "de Factura N&deg; ".$reg[0]['idventa']; } 
  else if($tipobusquedad=="2") { echo "de Caja N&deg; ".$reg[0]['nrocaja']." : ".$reg[0]['nombrecaja']; } 
  else { echo "de Fecha ".$fecha; } ?> </h3> <br>
...
<div class="row">
  <table border="0" align="center" >
   ...
   <?php if($reg[0]['cliente']!='0'){ ?>
    <tr>
      <td><strong>DPI de Cliente: </strong><?php echo $reg[0]['cedcliente']; ?></td>
    </tr>
    <tr>
    <td><strong>Nombre de Cliente:</strong> <?php echo $reg[0]['nomcliente']; ?></td>
  </tr>
...
if (isset($_GET['BuscaVentasCajas']) && isset($_GET['codcaja']) && isset($_GET['desde']) && isset($_GET['hasta'])) { 
 ...
 if($codcaja=="") {
     ...
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<center><span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR SELECCIONE CAJA DE VENTA PARA TU B&Uacute;SQUEDA</center>";
     echo "</div>";
   exit;
     ...
     echo "<br><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<center><span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR INGRESE FECHA DE INICIO PARA TU B&Uacute;SQUEDA</center>";
     echo "</div>";
   exit;
     ...
     echo "<br><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<center><span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR INGRESE FECHA FINAL PARA TU B&Uacute;SQUEDA</center>";
     echo "</div>";
   exit;
     ...
     echo "<br><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<center><span class='glyphicon glyphicon-info-sign'></span>&nbsp; LA FECHA DE INICIO NO PUEDE SER MAYOR QUE LA FECHA DE FIN</center>";
     echo "</div>";
   exit;
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Venta de Caja <?php echo "N&deg; ".$ca[0]['nrocaja']; ?> y Desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3></div>
<div class="panel-body">
...
<td class="actions"><div align="center"><a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("TICKET") ?>" target="_black" class="btn btn-info btn-xs" title="Ticket de Venta" ><i class="fa fa-print"></i></a>
...
<h3 class="panel-title">Ventas por Fechas Desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
                               
  <div id="div1"><div class="responsive-table" data-pattern="priority-columns">
        <table id="datatable-responsive" class="table table-striped table-bordered nowrap dataTable no-footer collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                          <th>C&oacute;digo de Venta</th>
...
<td><div align="center"><?php echo $reg[$i]['idventa']; ?></div></td>
...
<td class="actions"><div align="center">
       <a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("TICKET") ?>" target="_black" class="btn btn-info btn-xs" title="Ticket de Venta" ><i class="fa fa-ticket"></i></a>

<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("VENTAS") ?>" target="_black" class="btn btn-warning btn-xs" title="Factura de Venta" ><i class="fa fa-file-pdf-o"></i></a> </div>                                            </td>
                                                </tr>
                        <?php  }  ?>
                                                <tr>
                                                  <td></td>
...
<h3 class="panel-title">Productos Vendidos desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
...
<h3 class="panel-title">Ingredientes Vendidos desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
...
<h3 class="panel-title">Arqueos de Cajas desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
<h3 class="panel-title">Movimientos de <?php echo $reg[0]['nombrecaja']; ?> desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
<strong>Total Ingresos</strong> <?php echo number_format($TotalIngresos, 2, '.', ','); ?><br>
<strong>Total Egresos: </strong> <?php echo number_format($TotalEgresos, 2, '.', ','); ?><br>
...
<h3 class="panel-title">Informe de Ventas desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
<h3 class="panel-title">Informe de <?php echo $reg[0]['nombrecaja']; ?> desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
...
if($codcliente=="") {
     ...
     echo "<br><center><div class='alert alert-danger'>";
     echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
   echo "<span class='glyphicon glyphicon-info-sign'></span>&nbsp; POR FAVOR REALICE LA B&Uacute;SQUEDA DEL CLIENTE CORRECTAMENTE </center>";
   echo "</div>";
   exit;
...
<h3 class="panel-title">Creditos de Ventas del Cliente <?php echo $bon[0]['nomcliente']; ?></h3>
<br>
      ...
      <div id="div1"><div class="responsive-table" data-pattern="priority-columns">
                <table id="tech-companies-1" class="table table-striped table-bordered nowrap dataTable no-footer collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">                              
                  ...
                  <th data-priority="2">C&oacute;digo de Venta</th>
...
?>
                            <tr>
                           <td><?php echo $a++; ?></td>
                           <td><abbr title="Fecha Venta: <?php echo date("d-m-Y h:i:s",strtotime($bon[$i]['fechaventa'])); ?>"><?php echo $bon[$i]['idventa']; ?></abbr></td>
...
$forbon = $forbon->BuscaAbonosCreditos();  
 ?>
<br>
<h3 class="panel-title">Gesti&oacute;n de Pagos a Cr&eacute;ditos de Factura N&deg; <?php echo base64_decode($codventa); ?></h3>
<br>
...
<h3 class="panel-title">Creditos por Fechas Desde <?php echo $_GET["desde"]." hasta ".$_GET["hasta"]; ?></h3>
<br>
                                <div class="row"> 
                                <div class="col-md-12"> 
