...
include("pdf/documentos/funciones.php");
require "pdf/documentos/phpqrcode/qrlib.php";
...
//CREAR CLIENTE NUEVO O EDITAR CLIENTE SI EXISTE  
    ...
    if($id_cliente==""){
        $sql="INSERT INTO clientes (nombre_cliente, telefono_cliente, email_cliente, direccion_cliente, status_cliente, date_added,doc,dni,vendedor,pais,departamento,provincia,distrito,cuenta,tipo1,tienda,users,deuda,debe,documento) VALUES ('$nombre_cliente1','$tel1','$mail','$direccion','1','','$doc','$dni','','Peru','','','','','1','$tienda1','0','0','0','$documento')";
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','0','$nro_doc','$id_cliente','0','$id_vendedor','$condiciones','$sumador_total','$deuda','$tipo','$c','1','$ddd','1','$moneda1','$des','','0','2018-11-11','$dias','$folio','$des','','0','$motivo','$tip','$id_mesa')");
...
//DIRECCION DE PDF
header("location:pdf/documentos/ver_ticket.php?id_factura=$id_factura");
?>