...
$insert=mysqli_query($con,"UPDATE facturas SET numero_factura='$numero_factura',fecha_factura='$date',cod_hash='0',doc_mod='$nro_doc-$nro_doc1',id_cliente='$id_cliente',baja='0',id_vendedor='$id_vendedor',condiciones='$condiciones',total_venta='$sumador_total',deuda_total='$deuda',estado_factura='$tipo',tienda='$c',ven_com='1',activo='$ddd',servicio='1',moneda='$moneda1',nombre='$des',obs='',cuenta1='0',fec_eli='2018-11-11',dias='$dias',folio='$folio',des='$des',aceptado='',resumen='0',motivo='$motivo',tipo='$tip',id_mesa='$id_mesa',is_applied='1',observaciones='$observaciones' WHERE id_factura='".$id_factura."'");
$delete=mysqli_query($con,"DELETE FROM tmp WHERE session_id='".$session_id."'");

$delete1=mysqli_query($con,"DELETE FROM detalle_factura WHERE numero_factura='".$nro_doc1."' and folio='".$nro_doc."'");
...
if($tipo<=2 or $tipo==5 or $tipo==6 or $tipo==9 or $tipo==10){
    if($tipo==1){
    ...
    if($ruc=="0" and $dni=="0" and $ce<>""){
        $documento_usuario=$ce;
        $tipo_documento_usuario="4";
    }
...
<Invoice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
    ...
    if($tipo==6 or $tipo==10){//XML Nota de Credito
$xmlCPE = '<?xml version="1.0" encoding="UTF-8"?>
...
<cbc:PriceAmount currencyID="'.$cabecera["COD_MONEDA"].'">'.$cabecera["PRECIO_DET"].'</cbc:PriceAmount>
 ...
 if($tipo==5 or $tipo==9){//XML Nota de Débito
 $xmlCPE = '<?xml version="1.0" encoding="UTF-8"?>
