...
<table border="0" align="center" width="300px">
    <tr>
        <td colspan="4" align="center" >          
            <img style="width: 200px; height: auto; opacity: 0.9;" src="<?php echo $logo;?>"><br>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        ...
        <h2 style="margin-top: 5px; margin-bottom: 5px;">COCINA</h2>
        <?php echo $dir; ?><br>
        <strong>R.U.C: <?php echo $ruc; ?></strong>
        <!--<strong><?php echo $doc; ?></strong>
        <strong><?php $numero_factura2=str_pad($numero_factura, 8, "0", STR_PAD_LEFT);print"$folio-$numero_factura2"; ?></strong>-->
       </td>
    </tr>
    <tr>
      <td colspan="4">-------------------------------------------------------------------------</td>
...
<table border="0" align="center" width="300px">
    <tr>
        ...
        <td><strong>DESCRIPCIÓN DE PRODUCTO</strong></td>
...
$sql=mysqli_query($con, "select * from detalle_factura, facturas where  detalle_factura.numero_factura=facturas.numero_factura and detalle_factura.numero_factura=$numero_factura1 and detalle_factura.tienda=$tienda1 and facturas.ven_com=detalle_factura.ven_com and detalle_factura.tipo_doc='".$tipo1."' and facturas.id_factura='".$id_factura."' and detalle_factura.id_cliente='".$id_cliente."' and detalle_factura.fecha=(select fecha from detalle_factura where numero_factura=$numero_factura1 order by id_detalle desc limit 1)" );
$sql1=mysqli_query($con, "select * from detalle_factura, facturas where  detalle_factura.numero_factura=facturas.numero_factura and detalle_factura.numero_factura=$numero_factura1 and detalle_factura.tienda=$tienda1 and facturas.ven_com=detalle_factura.ven_com and detalle_factura.tipo_doc='".$tipo1."' and facturas.id_factura='".$id_factura."' and detalle_factura.id_cliente='".$id_cliente."' and detalle_factura.fecha!=(select fecha from detalle_factura where numero_factura=$numero_factura1 order by id_detalle desc limit 1)" );
}
$suma=0;
$codigo_producto="";
while ($row=mysqli_fetch_array($sql1))
    ...
    <?php
//// información del pedido nombre producto y cantidad
    if ($destino == 1) {
        echo "<tr>";
         echo "<td><strike>"."<strong>[ ".$cantidad1." ]</strong>"."</strike></td>";
        echo "<td><strike>".$nombre_producto."</strike></td>";
...
//// información del pedido nombre producto y cantidad
    ...
    <tr>
        <td colspan="4"><small><?php echo $observaciones; ?></small></td>
    </tr>
    <!--<tr>
    ...
    <tr>
        ...
        <!--<td colspan="4" align="center">Emitido desde<br><strong>www.<?php echo $url?></strong><br><br>
