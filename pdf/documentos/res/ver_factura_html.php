...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	$rw_cliente=mysqli_fetch_array($sql_cliente);
        ...
        if($estado==1 or $estado==2 or $estado==5 or $estado==6 or $estado==9 or $estado==10){                 
    ...
    <table cellspacing="0" style="width: 100%; text-align: " border="0">
		...
		<img style="width: 250px; height: auto;" src="<?php echo $logo;?>">	   
           </td>
           <td style="width: 35%; " align="right">		
               <strong><?php echo $nombre;?></strong>
               <br><small>De Clara Reyna Torres</small><br>
		...
		<?php
                ...
                if($rw_cliente['ce']>0){
                    $doc=$rw_cliente['doc'];
                    print'<font color="black"><strong>C.E.:</strong></font>';
                    echo $rw_cliente['ce'];
                }
...
if($estado==3 or $estado==8){                      
    ...
    <table cellspacing="0" border="0" style="width: 100%; text-align: left; font-size: 10pt;">
        ...
        <tr>
           <td colspan="3">    
               <font><strong>CLIENTE:</strong> <?php echo $rw_cliente['nombre_cliente'];?></font>
...
while ($row=mysqli_fetch_array($sql))
	...
	if($estado==3 OR $estado==5 OR $estado==6 OR $estado==9 OR $estado==10 OR $estado==8){ 
        if($suma<=20){
        ?>
	...
	$total_factura=number_format($sumador_total/1.18,2,'.','');
        ...
        $mo1="SOLES";
        $mon2="S/.";
        if($estado==1 or $estado==5 or $estado==6  or $estado==9 or $estado==10){
            $decimales = explode(".",number_format($subtotal,2));
            $entera=explode(".",$subtotal);
            $texto=convertir($entera[0]).' CON '. $decimales[1].'/100 '.$mo1;        
           ?>      
        <tr>
            <td colspan="4" height="10"><strong>IMPORTE EN LETRAS:</strong> <?php echo $texto;?></td>
            <td> </td>
        </tr>
        <tr>
      ...
      <tr>
        ...
        <tr>
            <td colspan="2"><img src="qr/<?php echo $id_factura;?>.png" width="100" height="100"></td><td colspan="3">
            Representación impresa de <strong><?php echo $tipo2;?></strong>. Verifica la validez de este comprobante en: <strong>www.sunat.gob.pe/ol-ti-itconsvalicpe/ConsValiCpe.htm</strong>
            <br>Autorizado mediante Resolución de Intendencia <strong>N° 032-005</strong>
            <!--<br><br>Representación impresa de <?php echo $tipo2;?>.-->
            <!--Consulte su documento electrónico en: <br><br><span style="font-size: 14px">http://ofertasde.net/sistemas</span>--><br>
            <strong>Resumen: </strong><?php echo $rw_cliente1['cod_hash'];?><br><br><br>
            <?php
               $url=$_SERVER["HTTP_HOST"];
            ?>
            Emitido desde <strong>www.<?php echo $url?></strong>
            </td>
        </tr> 
        <?php
        }
