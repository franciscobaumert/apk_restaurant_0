...
<body>      
	<div class="modal fade" id="nuevoProveedoresruc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">   
            <div class="modal-dialog" role="document">
		<div class="modal-content">   
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title" id="myModalLabel"><font color="black">Agregar nuevo Proveedor RUC</font></h5>
		  </div>
                      
                    <div id="resultados_ajax"></div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_proveedores_ruc" name="guardar_proveedores_ruc" autocomplete="off">
			...
			<div class="form-group">
				...
				<div class="input-group">
				  <input type="text" class="form-control"  id="ruc" name="doc" placeholder="Ingrese RUC de Proveedor" onKeyUp="this.value=this.value.toUpperCase();" required>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" autocomplete="off" class="form-control" id="nomclienteruc" name="nombre" placeholder="Nombres" required onKeyUp="this.value=this.value.toUpperCase();">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input type="text" class="form-control" id="direcclienteruc" name="direccion" placeholder="Dirección" onKeyUp="this.value=this.value.toUpperCase();">
