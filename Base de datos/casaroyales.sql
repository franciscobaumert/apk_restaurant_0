...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-07-2019 a las 18:16:24
...
('CASA ROYALES', 1, 1, 'SERVICIOS GENERALES', '-', '-', '-', 'LT. 12 MZ. 69 URB. PARCELACION SEMIRUSTICA C LIMA - LIMA - CIENEGUILLA', '-', '-', '-', '-', '-', 12, 10, 'logo.jpg', 'vision.jpg', 'mision.jpg', 'fotoHRtLZR2r.jpg', 'fotogMheCAPJ.jpg', 'fotogc7lAaze.jpg', '', '', 'comentario11', 'comentario21', 'comentario31', 'comentario41', 'comentario516', '10.00', '20.00', 3, 'MODDATOS', 'moddatos', '');
...
(3, 'guia', 0, '0', '0', '0', '0', '0', '0', 'T001', 'V002', 'V003', 'V004', 'V005', 'V006'),
...
--
-- Volcado de datos para la tabla `resumen_documentos`
--
...
(1, 1, 'CASA ROYALES', '10256964975', 'LT. 12 MZ. 69 URB. PARCELACION SEMIRUSTICA C LIMA - LIMA - CIENEGUILLA', 'INFO@DEVELOPER-TECHNOLOGY.COM', '951345257', 'sucursal2.jpg', '150109', 1, 'LIMA', 'LIMA', 'CIENEGUILLA');
...
--
ALTER TABLE `caja`
  MODIFY `id_caja` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=265;
...
--
ALTER TABLE `detalle_factura`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4950;

--
-- AUTO_INCREMENT de la tabla `documento`
--
ALTER TABLE `documento`
  MODIFY `id_documento` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `facturas`
  MODIFY `id_factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1240;
...
--
ALTER TABLE `products`
  MODIFY `id_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1372;

--
-- AUTO_INCREMENT de la tabla `resumen_documentos`
--
ALTER TABLE `resumen_documentos`
  MODIFY `id_resumen` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tmp`
  MODIFY `id_tmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8797;
