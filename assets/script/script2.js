...
$(".current-year").html((new Date).getFullYear() + ' CopyRight. Todos los derechos reservados. <a href="https://developer-technology.com/" target="_blank">Developer Technology</a>.');
$(".logo").html('<b>FACTURA<span>CION</span></b>');
//$(".logo").text('FACTURACION');
$(".logout").html('<i class="fa fa-power-off"></i>');
...
function mostrar(){
     ...
     if(div.style.display==='block'){
       ...
       //Actualizamos el nombre del bot¨®n
