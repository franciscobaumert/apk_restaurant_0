...
<head>
  ...
  <title>.:: Editar Pedido | Casa Royales ::. </title>
...
$(window).on("load", function() {
  ...
  $("#doc1" ).on( "keydown", function( event ) {
     ...
     $(document).ready(function(){
      load(1);
      $( "#resultados" ).load( "ajax/editar_facturacion2.php" );
  ...
  function agregar (id)
    {
      ...
      $.ajax({
        type: "POST",
        url: "./ajax/editar_facturacion2.php",
       ...
       var fecha = $("#fecha").val();
                    ...
                    var id_detalle = $("#id_detalle").val();
                        ...
                        if ((n == 11 && tip_doc==2) |  (n == 8 && tip_doc==1) ) {
                            VentanaCentrada('./pdf/documentos/pedido1.php?id_cliente='+id_cliente+'&id_vendedor='+id_vendedor+'&factura='+factura+'&dias='+dias+'&condiciones='+condiciones+'&fecha='+fecha+'&hora='+hora+'&moneda='+moneda+'&tcp='+tcp+'&folio='+folio+'&nro_doc='+nro_doc+'&motivo='+motivo+'&nombre_cliente='+nombre_cliente+'&doc1='+doc1+'&tip_doc='+tip_doc+'&tel1='+tel1+'&mail='+mail+'&direccion='+direccion+'&des='+des+'&tip='+tip+'&id_mesa='+id_mesa+'&observaciones='+observaciones+'&id_detalle='+id_detalle,'Factura','','1024','768','true');
